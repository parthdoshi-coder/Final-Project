...
class Department(models.Model):
    ...
    added_by = models.ForeignKey(User, on_delete=models.CASCADE, default=None, null=True, blank=True)
...
class Employee(models.Model):
    ...
    designation_id = models.ForeignKey(Designation, null=True, blank=True, on_delete=models.CASCADE)
...
class Leaves(models.Model):
    ...
    status = models.CharField(max_length=20, choices=[('pending', 'Pending'), ('cancel', 'Cancel'), ('approved', 'Approved'), ('rejected', 'Rejected')], default='pending')
...
class RequestedAttendance(models.Model):
    ...
    in_time = models.TimeField()
    out_time = models.TimeField(null=True, blank=True)
    request_type = models.CharField(max_length=10, choices=[('new', 'New Request'), ('change', 'Change Request')], default='new')
